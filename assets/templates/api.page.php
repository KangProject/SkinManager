<section>
	<div class="phpdoc">
		...
		<p>You need to send an http request (GET or POST) to <b>http://skin.outadoc.fr/json/</b> with the name of the method that you wish to call (param "method") and the params of that function (the name of the param) as args.</p>
