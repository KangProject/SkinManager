<section>
	<div class="phpdoc">
		<h2>Skin Manager API <small>documentation</small></h2>
		<h3>How to use the api ?</h3>
		<p>You need to send an http request (GET or POST) to <b>http://skinmanager.fr.nf/json/</b> with the name of the method that you wish to call (param "method") and the params of that function (the name of the param) as args.</p>
		<p>Exemple: to call the method "loadUserList", I'll make one of the following request:
		<br>GET http://skinmanager.fr.nf/json/?method=loadUserList&amp;match=Ephys
		<br>POST http://skinmanager.fr.nf/json/?method=loadUserList&amp;match=Ephys</p>
