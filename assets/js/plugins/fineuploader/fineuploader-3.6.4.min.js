...
qq.FineUploaderBasic.prototype = {
    ...
    getFile: function (a) {
        ...
        return new qq.PasteSupport({
            targetElement: this._options.paste.targetElement, callbacks: {
                log: function (b, c) {
                    a.log(b, c)
    ...
    _onBeforeAutoRetry: function (a, b) {
        ...
        return !1
    }, _maybeParseAndSendUploadError: function (a,
                                                b, c, d) {
    ...
    _upload: function (a, b, c) {
        ...
        }) : this._itemError("noFilesError", "") : (b = this._options.messages.tooManyItemsError.replace(/\{netItems\}/g, a).replace(/\{itemLimit\}/g, e), this._batchError(b))
    ...
    _onValidateCallbackFailure: function (a, b, c, d) {
        ...
        b.length > c && (a || !this._options.validation.stopOnFirstInvalidFile) && setTimeout(function () {
            ...
            f._handleCheckedCallback({
                ...
                onSuccess: qq.bind(f._onValidateCallbackSuccess,
                    f, b, c, d, e),
...
qq.UploadHandler = function (a) {
    ...
    e = {
        ...
        chunking: {
            enabled: !1, partSize: 2E6, paramNames: {
                partIndex: "qqpartindex", partByteOffset: "qqpartbyteoffset",
                chunkSize: "qqchunksize", totalParts: "qqtotalparts", filename: "qqfilename"
            }
        },
        resume: {enabled: !1, id: null, cookiesExpireIn: 7, paramNames: {resuming: "qqresume"}},
...
qq.UploadHandlerXhr = function (a, b, c, d) {
    ...
    function w(a) {
        ...
        if (b) {
            b = b.split(o);
            if (5 === b.length)return a = b[0], c = parseInt(b[1], 10), d = parseInt(b[2], 10), e = parseInt(b[3], 10), b = parseInt(b[4], 10), {
                uuid: a,
                part: c,
                lastByteSent: d,
